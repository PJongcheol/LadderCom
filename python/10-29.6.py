...
df = pd.read_excel('방한외래관광객_20210830.xlsx', skipfooter=3)
print(df.shape)
print(df.head())
...
ignore_list_2 = ['1.소계', '2소계', '3소계', '4소계']
df = df[df['분기'].isin(ignore_list_2) == False]

ignore_list_3 = ['2010 소계', '2011소계', '2012소계', '2013소계', '2014소계', '2015소계', '2016소계', '2017소계', '2018소계', '2019소계', '2020소계']
...
asia = ['중국', '일본', '대만', '홍콩', '마카오', '필리핀', '인도네시아', '태국', '베트남', '인도',
        ...
        '캄보디아', '스리랑카', '방글라데시', '파키스탄', '이스라엘', '이란', '아시아 기타']
american = ['미국', '캐나다', '브라질', '멕시코', '아메리카 기타']
europe = ['러시아', '영국', '독일', '프랑스', '이탈리아',
